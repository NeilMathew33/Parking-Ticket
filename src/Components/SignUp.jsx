                            ...
                            <div class="card-body ">
                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                        ...
                                        <input type="text" className="form-control" name="carmodel" value={input.carmodel} onChange={handleInput} />
                                    </div>
                                    ...
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        <label htmlFor="" className="form-label">Licence Plate</label>
                                       <input type="text" className="form-control" name="licenceplate" value={input.licenceplate} onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                    ...
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        <label htmlFor="" className="form-label">Driver Licence</label>
                                        <input type="file" name="driverlicence" id="driverlicence" className="form-control" onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        <label htmlFor="" className="form-label">Password</label>
                                        <input type="password" name="password" id="password" className="form-control" value={input.password} onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                        <label htmlFor="" className="form-label">Confirm Password</label>
                                        <input type="password" name="confirmPassword" id="confirmPassword" className="form-control" value={input.confirmPassword} onChange={handleInput} />
                                    </div>
                                    <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
